...
## Environments
- Preview: https://main--AEM.EDS-forms--MK-kapahi.hlx.page/
- Live: https://main--AEM.EDS-forms--MK-kapahi.hlx.live/
...
1. Open the `AEM.EDS-forms` directory in your favorite IDE and start coding :)
